...
function Column({ column }) {
  ...
  const dndKitColumnStyles = {
    // touchAction: 'none', // use for PointerSensor default sensor
    transform: CSS.Translate.toString(transform), // Not use CSS.Transform => stretch column bug
    transition,
    height: '100%',
    ...
    <div ref={setNodeRef} style={dndKitColumnStyles} {...attributes}>
      <Box
        ...
        sx={{
          ...
          borderRadius: '15px',
          height: 'fit-content',
          maxHeight: (theme) => `calc(${theme.levimana.boardContentHeight} - ${theme.spacing(5)})`
        }}
      >
        <Box sx={{
          height: (theme) => theme.levimana.columnHeaderHeight,
          p: 2,
          display: 'flex',
          alignItems: 'center',
        ...
        <Box sx={{
          height: (theme) => theme.levimana.columnFooterHeight,
          p: 2
        }}>
          {!openNewCardForm
            ? <Box sx={{
